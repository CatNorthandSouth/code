...
public class BsFile {
	...
	public String toString() {
		return "BsFile [fileId=" + fileId + ", fileName=" + fileName + ", filePath=" + filePath + ", fileCreateTime="
				+ fileCreateTime + ", fileUpAdmin=" + fileUpAdmin + ", fileUpId=" + fileUpId + ", fileLoadCount="
				+ fileLoadCount + ", fileSize=" + fileSize + ", fileType=" + fileType + ", fileDes=" + fileDes
