	...
	<div id="main-div" class="main-div">
		<div id="main-list-div" class="main-list-div">
			...
			<div id="main-header-div" class="main-header-div">
				...
				<em>></em>
				<a >${bsBigboard.biboTitle}</a>
				<em>></em>
				<a href="#" >${bsSmallboard.smboTitle}</a>
				<input type="hidden" id="main-bsSmallboardtext" value="${bsSmallboard.smboId}">
			</div id="" class="">
			<div class="main-foot-header">
				<span class="main-foot-header-title">${bsSmallboard.smboTitle}论坛</span>
				<span class="main-foot-header-banzhu">版主：${bsSmallboard.smboAdmin}</span>
			</div>
