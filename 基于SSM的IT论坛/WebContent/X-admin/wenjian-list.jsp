...
<html>
    ...
    <body>
        ...
        <div class="x-body">
            ...
            <xblock><button class="layui-btn layui-btn-danger" onclick="delAll()"><i class="layui-icon">&#xe640;</i>批量删除</button><button class="layui-btn" onclick="question_add('添加问题','wenjian-add.jsp','600','500')"><i class="layui-icon">&#xe608;</i>添加</button><span class="x-right" style="line-height:40px">共有数据：88 条</span></xblock>
    			...
    			init1("HfindFile",str);
    	   	       $.ajax({
       	        	...
       	        	success:function(data){
       	        		...
       	        		var str='';
       	        		var str1='';
       	        		str1=str1+'<tr><th><input type="checkbox" lay-filter="checkbox_v1" name="" value="'+pagecount+1+'"></th> <th>ID</th><th> 标题</th><th>分类</th><th>来源</th><th>更新时间</th><th>下载次数</th><th>操作</th></tr>';
       	        		for (var i = pagecount; i < pagecount1; i++) {
    						...
    						+'<a title="编辑" href="javascript:;" onclick="question_edit(\'编辑\',\'wenjian-edit.jsp?id='+((data.list)[0])[i].fileId+'\',\'4\',\'\',\'510\')" class="ml-5" style="text-decoration:none">'
    						+' <i class="layui-icon">&#xe642;</i>'
