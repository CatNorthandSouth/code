            ...
            <table class="layui-table">
                ...
                <tbody id="x-link">
                    <tr>
                        ...
                        <td class="td-manage">
                            <a title="编辑" href="javascript:;" onclick="rule_edit('编辑','rule-edit.jsp','4','','510')"
        ...
        <script>
            layui.use(['element','laypage','layer','form'], function(){
              ...
              form.on('submit(*)', function(data){
                ...
                $('#x-link').prepend('<tr><td><input type="checkbox"value="1"name=""></td><td>1</td><td>'+data.field.rules+'</td><td>'+data.field.name+'</td><td>'+data.field.cname+'</td><td class="td-manage"><a title="编辑"href="javascript:;"onclick="rule_edit(\'编辑\',\'link-edit.jsp\',\'4\',\'\',\'510\')"class="ml-5"style="text-decoration:none"><i class="layui-icon">&#xe642;</i></a> <a title="删除"href="javascript:;"onclick="rule_del(this,\'1\')"style="text-decoration:none"><i class="layui-icon">&#xe640;</i></a></td></tr>');
                return false;
              });
            })
