            ...
            <form class="layui-form layui-form-pane">
                ...
                <div class="layui-form-item">
                    <div class="layui-inline">
                        ...
                        <div class="layui-input-block">
                            <select lay-verify="required" name="cid" lay-filter="type_mid" id="cid">
                                <option>
                                </option>
        ...
        <script>
            ...
            editIndex = layedit.build('L_content');
              ...
              form.on('submit(add)', function(data){
                console.log(data);
                $.ajax({
                	url:"${pageContext.request.contextPath}/HinsertGongGao",
                	type:"post",
                	data:{
                		title:$("#L_title").val(),
              ...
              // 		for (var i = 0; i < data[0].length; i++) {
               			str=str+'<optgroup value="0" label="公告">';
               		//	for (var j = 0; j < (data[1])[i].length; j++) {
               				str=str+'<option value="0">公告</option>';
